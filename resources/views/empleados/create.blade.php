                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('empleados.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="clave_empleado" class="block w-full mt-1" type="text" name="clave_empleado" :value="old('clave_empleado')" required autocomplete="clave_empleado" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="fecha_ingreso" class="block w-full mt-1" type="date" name="fecha_ingreso" :value="old('fecha_ingreso')" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="puesto_empleado" class="block w-full mt-1" type="text" name="puesto_empleado" :value="old('puesto_empleado')" required />
