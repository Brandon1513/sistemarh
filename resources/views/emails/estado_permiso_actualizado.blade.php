<!DOCTYPE html>
<html lang="es">
<head><meta charset="UTF-8"><title>Estado de Permiso Actualizado</title></head>
    ...
    <tr><td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%;">
            ...
            <tr><td style="background:#fff; padding:28px 36px 0;">
                ...
                <h1 style="margin:0 0 8px; font-size:22px; font-weight:800; color:#2c1a30;">Estado de Permiso Actualizado</h1>
                <p style="margin:0; font-size:14px; color:#7a6682;">El estado de tu solicitud de permiso ha sido actualizado.</p>
            </td></tr>
            <tr><td style="background:#fff; padding:20px 36px 0;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background:#e8f5ee; border:1.5px solid #b3dfc3; border-radius:10px; padding:16px;">
                    <tr>
                        ...
                        <td>
                            <p style="margin:0; font-size:15px; font-weight:800; color:#1b6b38;">Permiso Aprobado</p>
                            <p style="margin:3px 0 0; font-size:12px; color:#2d7a4f;">Tu solicitud de permiso ha sido aprobada.</p>
                        </td>
                    </tr>
                </table>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background:#fce8ee; border:1.5px solid #f0b3c3; border-radius:10px; padding:16px;">
                    <tr>
                        <td style="font-size:24px; padding-right:12px; vertical-align:middle;">❌</td>
                        <td>
                            <p style="margin:0; font-size:15px; font-weight:800; color:#7a2039;">Permiso Rechazado</p>
                            <p style="margin:3px 0 0; font-size:12px; color:#AA4969;">Tu solicitud de permiso no fue aprobada. Contacta a tu jefe directo.</p>
                        </td>
                    </tr>
                </table>
                @else
                <table width="100%" cellpadding="0" cellspacing="0" style="background:#faf3e0; border:1.5px solid #EED39B; border-radius:10px; padding:16px;">
                    <tr>
                        <td style="font-size:24px; padding-right:12px; vertical-align:middle;">🔄</td>
                        <td>
                            <p style="margin:0; font-size:15px; font-weight:800; color:#473524;">Estado: {{ ucfirst($estado) }}</p>
                            <p style="margin:3px 0 0; font-size:12px; color:#7a6050;">Tu solicitud ha sido actualizada.</p>
                        </td>
                    </tr>
                </table>
                @endif
            ...
            <tr><td style="background:#fff; padding:20px 36px;">
                <p style="margin:0; font-size:13px; color:#7a6682;">Si tienes dudas, por favor contacta a tu jefe directo o al área de Recursos Humanos.</p>
            </td></tr>
