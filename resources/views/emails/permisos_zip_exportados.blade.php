...
<head>
    ...
    <title>Archivo ZIP listo para descargar</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%;">
                    ...
                    <tr>
                        <td style="background:#fff; padding:28px 36px 0;">
                            ...
                            <h1 style="margin:0 0 8px; font-size:22px; font-weight:800; color:#2c1a30;">Tu archivo ZIP está listo 📦</h1>
                            <p style="margin:0; font-size:14px; color:#7a6682; line-height:1.6;">La exportación de permisos ha sido completada exitosamente. Puedes descargar el archivo ZIP desde el botón a continuación.</p>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background:#f3eef5; border-radius:10px; border:1px solid #e6d9ed; padding:16px;">
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <p style="margin:0; font-size:13px; font-weight:700; color:#2c1a30;">Archivo ZIP — Permisos exportados</p>
                    ...
                    <tr>
                        <td style="background:#fff; padding:24px 36px;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $downloadLink }}" style="display:inline-block; background:#6A2C75; color:#fff; text-decoration:none; font-size:14px; font-weight:700; padding:13px 32px; border-radius:9px; letter-spacing:.03em;">
                                            Descargar ZIP
                                        </a>
                                    </td>
                                </tr>
